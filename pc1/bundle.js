...
/***/ function(module, exports, __webpack_require__) {
	...
	function recommendnormal(recommend, recommendli, w, d){
	     ...
	     if (d == 5 || d == 6){
	         recommend.text("Umarız şu ana kadar sorunsuz bir gebelik geçirmişsindir. Bugün itibari ile " + week + ". haftanın son günlerindesiniz. " + week + ". hafta ile ilgili bilgileri tekrar gözden geçirmenizi tavsiye ederiz. Ayrıca sayfanın sonundan bir sonraki haftanın bilgilerini okuyarak önümüzdeki haftaya hazır başlamanızı tavsiye ederiz.");
	         recommendli.show();
